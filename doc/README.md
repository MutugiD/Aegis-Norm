...
The [F03 framework walkthrough](implementation/03-framework-registration.md) explains FakeTensor metadata, Autograd redispatch and operator checks. Its native T4 validation is pending.
