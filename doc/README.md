...
Next: [F04 measurement foundation](implementation/04-kernel-measurements.md), which records paired eager/native samples before kernel tuning. Initial T4 timing evidence is pending.
